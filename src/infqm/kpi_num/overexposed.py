...
"""Ration of very high pixel values compared to the rest."""
...
class OverExposed(BaseMetric):
    """Class to compute overexposure of an image."""

    def get_exposure_limit(self) -> int:
        """Threshold for Exposure.

        Returns:
            int - pixel value above which is considered overexposed (0-255).
        """
        return 240
    ...
    def calculate(self, cv_image):
        ...
        return np.sum(hist[self.get_exposure_limit() :])  # Very bright pixels
